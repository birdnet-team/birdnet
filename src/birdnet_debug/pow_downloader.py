...
URL = "https://zenodo.org/records/4656848/files/wav_Files.zip?download=1"
DEST_DIR = Path("test-dataset/POW")
ZIP_FILE = DEST_DIR / "wav_Files.zip"
...
def get_pow_file_paths() -> list[Path]:
  """Gibt eine Liste der Pfade zu den Dateien im Zielverzeichnis zurück."""
  return list(DEST_DIR.glob("**/*.wav")) + list(DEST_DIR.glob("**/*.WAV"))
