...
from birdnet.acoustic_models.inference.pipelines import predict_species_from_recordings
  ...
  def _predict_embeddings(
    ...
    *,
    ...
    result = EmbeddingsTensor(
      ...
      emb_dim=AcousticModelBaseV2_4.get_embeddings_dim(),
    ...
    if show_stats in ("minimal", "progress"):
      bmm = MinimalBenchmarkEmbMetaV2_4(
  ...
  def _predict(
    ...
    *,
    ...
    return predict_species_from_recordings(
      ...
      model_segment_size_samples=self.get_segment_size_samples(),
