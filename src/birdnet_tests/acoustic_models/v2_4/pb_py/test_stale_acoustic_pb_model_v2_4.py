...
from birdnet.acoustic.models.v2_4.pb import _PB_DL_URL, AcousticPBDownloaderV2_4
...
def _prepare(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> Path:
  ...
  create_fake_lang_dir(lang_dir, AcousticPBDownloaderV2_4.AVAILABLE_LANGUAGES)
  monkeypatch.setattr(
...
def test_cached_model_without_marker_is_not_available(
  ...
  assert not AcousticPBDownloaderV2_4._check_acoustic_model_available()
...
def test_cached_model_from_the_current_release_is_available(
  ...
  assert AcousticPBDownloaderV2_4._check_acoustic_model_available()
