...
def test_invalid_audio_file_path_raises_value_error(model: ModelV2M4Protobuf):
...
def test_invalid_batch_size_raises_value_error(model: ModelV2M4Protobuf):
...
def test_invalid_chunk_overlap_s_raises_value_error(model: ModelV2M4Protobuf):
...
def test_invalid_bandpass_fmin_raises_value_error(model: ModelV2M4Protobuf):
...
def test_invalid_bandpass_fmax_raises_value_error(model: ModelV2M4Protobuf):
...
def test_invalid_sigmoid_sensitivity_raises_value_error(model: ModelV2M4Protobuf):
