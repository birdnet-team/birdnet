...
from birdnet.model_loader import load_custom2


def test_types_are_correct():
  assert load_custom2("acoustic", "2.4", "pb", "", "") is AcousticPBModelV2_4
  assert load_custom2("acoustic", "2.4", "tf", "", "") is AcousticTFModelV2_4
  assert load_custom2("acoustic", "3.0", "tf", "", "") is AcousticTFModelV3_0
  assert load_custom2("geo", "2.4", "pb", "", "") is GeoPBModelV2_4
  assert load_custom2("geo", "2.4", "tf", "", "") is GeoTFModelV2_4
