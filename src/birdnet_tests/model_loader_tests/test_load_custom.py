  ...
  assert (
    type(
      load_custom(
        ...
        "2.4",
        "pb",
        get_local_model_root_dir("acoustic", "2.4", "pb") / "model",
        get_local_model_root_dir("acoustic", "2.4", "pb") / "labels" / "en_us.txt",
      )
    )
  ...
  assert (
    type(
      load_custom(
        ...
        "2.4",
        "tf",
        get_local_model_root_dir("acoustic", "2.4", "tf") / "model-fp32.tflite",
        get_local_model_root_dir("acoustic", "2.4", "tf") / "labels" / "en_us.txt",
      )
    )
  ...
  assert (
    type(
      load_custom(
        ...
        "2.4",
        "pb",
        get_local_model_root_dir("geo", "2.4", "pb") / "model",
        get_local_model_root_dir("geo", "2.4", "pb") / "labels" / "en_us.txt",
      )
    )
    is GeoPBModelV2_4
  )
  assert (
    type(
      load_custom(
        ...
        "2.4",
        "tf",
        get_local_model_root_dir("geo", "2.4", "tf") / "model.tflite",
        get_local_model_root_dir("geo", "2.4", "tf") / "labels" / "en_us.txt",
      )
    )
    is GeoTFModelV2_4
  )
