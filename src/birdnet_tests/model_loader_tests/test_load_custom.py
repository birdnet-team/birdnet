...
def test_types_are_correct():
  assert load_custom("acoustic", "2.4", "pb", "", "") is AcousticPBModelV2_4
  assert load_custom("acoustic", "2.4", "tf", "", "") is AcousticTFModelV2_4
  assert load_custom("geo", "2.4", "pb", "", "") is GeoPBModelV2_4
  assert load_custom("geo", "2.4", "tf", "", "") is GeoTFModelV2_4
